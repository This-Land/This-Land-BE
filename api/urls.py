...
urlpatterns = [
    ...
    path('pointsofinterest/<int:PointOfInterest_id>/change/', api_views.POIDetailView.as_view()),
    ...
    path('tellyourstory/<int:TellYourStory_id>/change/', api_views.TYSDetailView.as_view()),
]
