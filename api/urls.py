...
urlpatterns = [
    ...
    path('pointsofinterest/<int:PointOfInterest_id>/edit/', api_views.POIDetailView.as_view()),
    ...
    path('tellyourstory/<int:TellYourStory_id>/edit/', api_views.TYSDetailView.as_view()),
]
